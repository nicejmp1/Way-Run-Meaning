...
$sql = "SELECT b.boardID, b.boardTitle, m.youNickName, b.regTime, b.boardView FROM board2 b JOIN members m ON (b.memberID = m.memberID) ORDER BY boardID DESC LIMIT {$viewLimit}, {$viewNum}";
$result = $connect -> query($sql);
...
if($page < $boardTotalCount){
    ...
    echo "<li class='last'><a href='comm_crew.php?page={$boardTotalCount}'>마지막으로</a></li>";
}
?>
                        </ul>
                    </section>
