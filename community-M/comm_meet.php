<?php
    ...
    // 총 게시글 개수
    $sql = "SELECT count(boardID) AS total FROM board3 WHERE boardDelete = 1";
    ...
    $sqlPinned = "SELECT b.boardID, b.boardTitle, m.youNickName, b.regTime, b.boardView, b.isPinned 
                  FROM board3 b JOIN members m ON (b.memberID = m.memberID) 
...
if($page < $totalPages){
    ...
    echo "<li class='last'><a href='comm_meet.php?page={$totalPages}'>마지막으로</a></li>";
}
?>
                    </ul>
                </section>
