...
<?php
    ...
    $sql = "SELECT * FROM board3 WHERE boardID = {$boardID}";
    ...
    if($result){
        ...
        echo "<div><label for='boardPass' class='mt50'>비밀번호</label><input type='password' id='boardPass' name='boardPass' class='input-style mb10' autocomplete='off' placeholder='글을 수정하려면 로그인 비밀번호를 입력하셔야 합니다.' required></div>";
    }
?>
                            <div class="btn_04">
